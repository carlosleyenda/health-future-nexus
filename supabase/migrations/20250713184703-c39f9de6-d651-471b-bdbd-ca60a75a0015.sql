...
INSERT INTO public.profiles (user_id, email, first_name, last_name) VALUES
('11111111-1111-1111-1111-111111111111', 'patient@demo.com', 'Ana', 'García'),
('22222222-2222-2222-2222-222222222222', 'doctor@demo.com', 'Dr. Carlos', 'Rodríguez'),
('33333333-3333-3333-3333-333333333333', 'admin@demo.com', 'Admin', 'Sistema'),
('44444444-4444-4444-4444-444444444444', 'enterprise@demo.com', 'Empresa', 'Salud'),
('55555555-5555-5555-5555-555555555555', 'pharmacy@demo.com', 'Farmacia', 'Central')
...
('44444444-4444-4444-4444-444444444444', 'enterprise'),
('55555555-5555-5555-5555-555555555555', 'pharmacy')
