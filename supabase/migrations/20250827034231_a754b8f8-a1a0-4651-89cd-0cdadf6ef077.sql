...
-- Create sample users with fixed UUIDs to populate the system
-- Insert demo profiles if they don't exist
INSERT INTO public.profiles (user_id, email, first_name, last_name)
VALUES 
  ('demo-patient-001', 'ana.garcia@example.com', 'Ana', 'García'),
  ('demo-doctor-001', 'carlos.rodriguez@example.com', 'Carlos', 'Rodríguez'),
  ('demo-admin-001', 'admin@system.com', 'Admin', 'Sistema')
ON CONFLICT (user_id) DO NOTHING;

-- Insert demo user roles
INSERT INTO public.user_roles (user_id, role)
VALUES 
  ('demo-patient-001', 'patient'),
  ('demo-doctor-001', 'doctor'),
...
VALUES
  ('demo-doctor-001', 1, '09:00', '17:00'),
  ('demo-doctor-001', 2, '09:00', '17:00'),
  ('demo-doctor-001', 3, '09:00', '17:00'),
  ('demo-doctor-001', 4, '09:00', '17:00'),
  ('demo-doctor-001', 5, '09:00', '17:00')
ON CONFLICT DO NOTHING;